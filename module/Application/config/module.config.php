...
return array(
  ...
  'service_manager' => array(
    ...
    'factories' => array(
      ...
      'Application\Model\CommentTableGateway' =>  function($sm) {
        $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
        $resultSetPrototype = new Zend\Db\ResultSet\ResultSet();
        $resultSetPrototype->setArrayObjectPrototype(new Application\Model\Comment());
        $tableGateway = new Zend\Db\TableGateway\TableGateway('comments', $dbAdapter, null, $resultSetPrototype);
